...
def render(cluster: dict[str, Any], node: dict[str, Any], *, production: bool) -> dict[str, str]:
    ...
    controller: dict[str, Any] = {
        ...
        "final_countdown_route_maximum_cells": 100000,
        "final_countdown_route_minimum_cell_size": 1.0,
        "final_countdown_route_retry_maximum_cells": 250000,
        "final_countdown_route_retry_minimum_cell_size": 0.5,
        "final_countdown_route_wall_clearance_cells": 0.3,
        "final_countdown_grief_early_window_seconds": 8.0,
        "final_countdown_grief_late_window_seconds": 3.0,
        "final_countdown_grief_early_grace_seconds": 6.0,
        "final_countdown_grief_late_grace_seconds": 2.0,
        "final_countdown_grief_early_required_fraction": 0.3,
        "final_countdown_grief_late_required_fraction": 0.9,
        ...
        "afk_dead_timeout_seconds": 60,
        "afk_poll_interval_seconds": 1.0,
        "afk_probe_interval_seconds": 2.0,
        "afk_position_epsilon": 0.01,
        "afk_straight_death_limit": 4,
        "afk_straight_minimum_distance": 6.0,
        "afk_straight_ratio": 0.92,
        "afk_straight_maximum_turn_degrees": 20,
        "afk_confinement_seconds": 60,
        "afk_confinement_maximum_span": 12.0,
        "afk_recovery_input_seconds": 2.5,
        "afk_recovery_motion_seconds": 3.0,
        "afk_recovery_distance": 4.0,
    ...
    if firebase_enabled:
        ...
        if live_enabled:
            if role != "leader":
                raise ConfigurationError("only the leader may publish the live dashboard")
    ...
    if production:
        ...
        if master_list and role == "standalone":
            raise ConfigurationError("standalone examples must be validated before master listing")
